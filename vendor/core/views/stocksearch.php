...
<body>
    ...
    <main id='main'>
        ...
        <section id="stock-gallery">
            <form id="stock-form-search" action="" method="POST">
                <div id="stock-gallery-container">
                </div>
            <?php echo isset($_SESSION['token']) ? '<input type="submit" id="subm" value="Add chosen"></input>': '' ?>
            </form>
        </section>
    </main>
    <footer>
